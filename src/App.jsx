import React, { useState, useEffect, useRef } from 'react';
    ...
    function Task({ task, targetDate, onDelete, onEdit, timelineStart, timelineEnd }) {
      ...
      return (
        <li
          ref={taskRef}
          className="bg-white shadow rounded p-4 mb-4 flex justify-between items-center absolute top-0"
          style={{ left: `${taskPosition}%`, width: '150px' }}
        >
          {isEditing ? (
            ...
            <>
              ...
              <div className="flex gap-2">
                <button onClick={handleEdit} className="bg-yellow-500 hover:bg-yellow-700 text-white font-bold py-2 px-4 rounded">Edit</button>
            ...
            <>
              ...
              <div className="relative">
                ...
                {Object.entries(timelineTasks).sort(([keyA], [keyB]) => {
                  ...
                  <div key={tMinusLabel} className="mb-8">
